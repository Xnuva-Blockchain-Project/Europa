...
"""Verify that starting europa with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start europa with -h for help text")
        ...
        self.log.info("Start europa with -version for version information")
        ...
        self.log.info("Start europad with -fakearg to make sure it does not start")
