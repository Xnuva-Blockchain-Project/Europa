...
public:
    enum Base58Type {
        PUBKEY_ADDRESS,
        SCRIPT_ADDRESS,
        // EUROPA WALLET COMPATIBILITY: legacy encoder uses this second
        // script-hash prefix while decoder accepts both script prefixes.
        SCRIPT_ADDRESS2,
        SECRET_KEY,
        EXT_PUBLIC_KEY,
        EXT_SECRET_KEY,
    ...
    bool LegacyWitnessUnknownBech32() const { return m_legacy_witness_unknown_bech32; }
...
protected:
    ...
    bool m_legacy_witness_unknown_bech32{true};
