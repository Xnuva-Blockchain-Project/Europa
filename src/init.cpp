 ...
 */
static const char* BITCOIN_PID_FILENAME = "europad.pid";
...
std::string LicenseInfo()
{
    ...
    return std::string("2026 Maintained by the Xnuva Blockchain Project") + "\n" +
           "Copyright \xC2\xA9 2023" "\xE2\x80\x93" "2026 Xnuva Blockchain Project\n" +
           "Copyright \xC2\xA9 2011" "\xE2\x80\x93" "2023 The Litecoin Core developers\n" +
           "Copyright \xC2\xA9 2009" "\xE2\x80\x93" "2023 The Bitcoin Core developers\n" +
           "\n" +
           strprintf(_("Please contribute if you find %s useful. "
                       "Visit %s for further information about the software."),
               PACKAGE_NAME, URL_WEBSITE) +
           "\n" +
           _("The source code is maintained by the Xnuva Blockchain Project.") +
           "\n" +
           "\n" +
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if europa is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if europa is started while in a temporary directory.\n",
