...
public:
    ...
    // Total wallet-owned coinbase value recorded in blocks that are no longer
    // in the active chain. Diagnostic only; never spendable balance.
    CAmount GetInactiveMinedBalance() const;
